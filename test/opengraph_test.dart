...
class MockOpenGraphRequest extends Mock implements OpenGraphRequestInterface {
  ...
  Future<OpenGraphEntity?> fetch(String url) => super.noSuchMethod(
      ...
      returnValue: Future.value(OpenGraphEntity(
        ...
        url: 'https://example.com', locale: 'en', type: 'website', siteName: 'Example Site',
      )),
  ...
  group('OpenGraphPreview', () {
    testWidgets('displays loading indicator while fetching data', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: OpenGraphPreview(url: 'https://example.com', provider: mockRequest),
      ));

      expect(find.byType(CupertinoActivityIndicator), findsOneWidget);
    });

    testWidgets('displays OpenGraph data when fetched', (WidgetTester tester) async {
